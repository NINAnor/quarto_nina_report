...
% Use bundled fonts
\newcommand{\fontpath}{_extensions/NINAnor/ninareport/fonts/}
...
\fancypagestyle{titlefooter}{%
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south west, xshift=1.9cm, yshift=1.9cm] at (current page.south west) {
        \includegraphics[height=1.5cm]{_extensions/NINAnor/ninareport/logo.eps}
    };
...
\end{tikzpicture}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=south east, xshift=-4.8cm, yshift=2.8cm] at (current page.south east) {
        \includegraphics[height=1.6cm]{_extensions/NINAnor/ninareport/logo.eps}
    };
